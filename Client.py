...
image = Image.open("/Users/tobiaslundgaard/Desktop/Semester 5/Projekt5/test.jpg")
...
task.appendImage(fileName=image_path, image=numpydata, location=complex(10.0, 20.0))
